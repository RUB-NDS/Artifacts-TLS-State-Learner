...
public class IgnoredInputIssue extends StateMachineIssue {

    private final List<TlsWord> noFailFastFlows;
    private final ResponseFingerprint response;

    public IgnoredInputIssue(List<TlsWord> noFailFastFlows, String reason) {
        super(StateMachineIssueType.NO_FAIL_FAST, reason);
        this.noFailFastFlows = noFailFastFlows;
        this.response = null;
    }

    public IgnoredInputIssue(
