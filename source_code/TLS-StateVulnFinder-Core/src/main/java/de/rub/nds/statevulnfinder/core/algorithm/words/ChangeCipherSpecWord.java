 ...
 * @author robert
 */
public class ChangeCipherSpecWord extends TlsWord {

    public ChangeCipherSpecWord() {
        super(TlsWordType.CCS);
    }

    @Override
    public ResponseFingerprint execute(State state, ReceiveHint receiveHint) {
        sendMessage(new ChangeCipherSpecMessage(), new Record(), state);
        return receiveMessages(state, receiveHint);
    }

    @Override
    public String toString() {
        return "ChangeCipherSpecWord{" + '}';
    }
